...
public class JSONParser {
	...
	public Pair<JSONValue, List<ParseError>> parseValue(String json) throws ParseError {
		...
		if (json == null)
			raise("Input string may not be null");
		length = json.length();
		src = json;
	...
	/**
	 * Skips the line comment starting at the current position and records
	 * a recoverable error.
	 */
	...
	/**
	 * Skips the block comment starting at the current position and records
	 * a recoverable error.
	 */
