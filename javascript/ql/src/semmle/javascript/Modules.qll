...
abstract class Import extends ASTNode {
  ...
  /**
   * Gets the module this import refers to, considering non-heuristic strategies.
   */
  private Module resolveBasic() {
  ...
  Module getImportedModule() {
    if exists(resolveBasic()) then result = resolveBasic() else result = resolveByAbsolutePath()
  }
}
