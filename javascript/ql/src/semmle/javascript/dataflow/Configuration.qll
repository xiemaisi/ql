...
private predicate storeStep(DataFlow::Node pred, DataFlow::Node succ, string prop,
  ...
  cfg = any(DataFlow::Configuration c)
  or
  exists (Function f, DataFlow::Node mid |
    ...
    returnsObjectWithProperty(f, prop,  mid, cfg)
  )
}
 ...
 * is stored.
 */
private predicate returnsObjectWithProperty(Function f, string prop, DataFlow::Node rhs, DataFlow::Configuration cfg) {
